...
def getDataPkl(file_name):
  ...
  for i in range(20):
    try:
      ...
      data = pd.read_csv("/root/amonsense/"+"pickle/"+file_name)
      file_name = file_name.replace(".csv",".pkl")
      data.to_pickle("/root/amonsense/"+"pickle/"+file_name)
      data = pd.read_pickle("/root/amonsense/"+"pickle/"+file_name)
...
class senseDataset(DGLDataset):
    ...
    def process(self):
        ...
        data_path = "/root/amonsense/"+"Master TU KL/Master Thesis/online-recognition/dataset/"
